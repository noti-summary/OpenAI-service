...
export const gpt4Router = Router();
...
gpt4Router.post('/', async (req: Request, res: Response): Promise<void> => {
  try {
...
gpt4Router.post('/key', async(req: Request, res: Response): Promise<void> => {
    try{
        const prompt: string = req.body.prompt;
        const content: string = req.body.content;
